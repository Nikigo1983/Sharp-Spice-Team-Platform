...
const PRESETS = [
...

  {
    ...
    label: "Ответы на анкету",

    text: "Составь официальные ответы на вопросы temporary residence / Digital Nomad. Сохрани текст каждого вопроса, ответь statement на английском по заметкам клиента, в конце Place/Date/Signature. Недостающие факты не выдумывай — отметь что уточнить.",
