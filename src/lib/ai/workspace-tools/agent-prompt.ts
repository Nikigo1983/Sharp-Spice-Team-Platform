...
21. Поиск клиентов по ФИО: учитывай русские падежи и род (Музыкина ↔ Музыкин, Пермяковой ↔ Пермякова). Не ищи точную строку запроса; сопоставляй леммы имени и фамилии. Если несколько вариантов — уточни, не говори «не найден».
`.trim();
