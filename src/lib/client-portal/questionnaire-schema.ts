  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          placeholder: { en: "IVAN IVANOV", ru: "IVAN IVANOV" },
          required: true,
          layout: "full",
          script: "latin",
        },
        ...
        },
        {
          ...
          order: 170,
          label: {
            en: "13. Father: given name, surname (Latin)",
            ru: "13. Отец: Имя, Фамилия (латинскими)",
          },
          placeholder: { en: "IVAN IVANOV", ru: "IVAN IVANOV" },
          layout: "half",
          script: "latin",
        },
        {
          ...
          order: 180,
          label: {
            en: "14. Mother: given name, surname (Latin)",
            ru: "14. Мать: Имя, Фамилия (латинскими)",
          },
          placeholder: { en: "MARIA IVANOVA", ru: "MARIA IVANOVA" },
          layout: "half",
          script: "latin",
        },
      ],
