      ...
      questions: [
        {
          ...
          order: 10,
          label: {
            en: "1. Given name, patronymic, surname (Cyrillic)",
            ru: "1. Имя, Отчество, Фамилия (кириллицей)",
          },
          placeholder: {
            en: "Ivan Ivanovich Ivanov",
            ru: "Иван Иванович Иванов",
          },
          required: true,
          layout: "full",
        },
        {
          ...
          order: 20,
          label: {
            en: "2. Given name, patronymic, surname (Latin)",
            ru: "2. Имя, Отчество, Фамилия (латинскими)",
          },
          placeholder: { en: "IVAN IVANOVICH IVANOV", ru: "IVAN IVANOVICH IVANOV" },
          required: true,
          layout: "full",
          script: "latin",
        },
        ...
        },
        {
          ...
          order: 170,
          label: {
            en: "13. Father: given name, patronymic, surname (Latin)",
            ru: "13. Отец: Имя, Отчество, Фамилия (латинскими)",
          },
          placeholder: {
            en: "IVAN IVANOVICH IVANOV",
            ru: "IVAN IVANOVICH IVANOV",
          },
          layout: "half",
          script: "latin",
        },
        {
          ...
          order: 180,
          label: {
            en: "14. Mother: given name, patronymic, surname (Latin)",
            ru: "14. Мать: Имя, Отчество, Фамилия (латинскими)",
          },
          placeholder: {
            en: "MARIA IVANOVNA IVANOVA",
            ru: "MARIA IVANOVNA IVANOVA",
          },
          layout: "half",
          script: "latin",
        },
